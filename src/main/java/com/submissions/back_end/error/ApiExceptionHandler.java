package com.submissions.back_end.error;
...
//	@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR)
	public @ResponseBody ResponseEntity<ResponseBodyDto<Object>> handleException1(Exception ex, WebRequest request) {
		// quá trình kiểm soat lỗi diễn ra ở đây
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		ResponseBodyDto<Object> dtoResult = new ResponseBodyDto<>();
	...
	public @ResponseBody ResponseEntity<ResponseBodyDto<Object>> errorMethodArgumentNotValidException(
	...
	public @ResponseBody ResponseEntity<ResponseBodyDto<Object>> handleWhitelabelErrorException(Exception ex,
			WebRequest request) {
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		ResponseBodyDto<Object> dtoResult = new ResponseBodyDto<>();
	...
	public @ResponseBody ResponseEntity<ResponseBodyDto<Object>> handleIllegalArgumentException(Exception ex) {
		// quá trình kiểm soat lỗi diễn ra ở đây
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		ResponseBodyDto<Object> dtoResult = new ResponseBodyDto<>();
	...
	public @ResponseBody ResponseEntity<ResponseBodyDto<Object>> handleError405(HttpServletRequest request,
			Exception e) {
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		ResponseBodyDto<Object> dtoResult = new ResponseBodyDto<>();
	...
	public @ResponseBody ResponseEntity<ResponseBodyDto<Object>> handleDataIntegrityViolationException(Exception ex,
			WebRequest request) {
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		ResponseBodyDto<Object> dtoResult = new ResponseBodyDto<>();
